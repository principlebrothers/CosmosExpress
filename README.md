...
<div align="center">
  ...
  <h3><b>COSMOS EXPRESS BLOG WEB APPLICATION</b></h3>
...
# 📖 [COSMOS EXPRESS] <a name="about-project"></a>

> A simple blog web app to understand rails and it design principles like Model View Controller (MVC)

**[Cosmos Express]** is a bloging web app that can be use to share ideas with other around the world.
...
- [Live Demo Link is under construction](https://yourdeployedapplicationlink.com)
...
```sh
  cd my-folder
  git clone git@github.com:principlebrothers/CosmosExpress.git
```
...
Feel free to check the [issues page](https://github.com/principlebrothers/CosmosExpress/issues/new).
...
If you like this project by me a [drink](.../.../)
...
I would like to thank [Microverse](https://github.com/principlebrothers/CosmosExpress/issues/new) for inspiring this project
...
- **Is is easy to learn Ruby on Rails**
